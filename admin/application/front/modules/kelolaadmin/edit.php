...
<div class="page-content">
	<div class="row">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form action="application/front/modules/kelolaadmin/update.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id="form">	
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="nama" id="nama" placeholder="Nama lengkap" class="col-xs-10 col-sm-5" required="true" value="<?php echo $default['nama'];?>">
						</div>
					</div>         
	...
	frm.submit(function (ev) {
		$.ajax({
			...
			success: function (output) {
				if(output=="true"){
					window.location.href = "kelolaadmin";
				}else{
					window.location.href = "kelolaadmin";
				}
			},
